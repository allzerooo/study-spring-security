...
public class JwtKey {
    /**
     * Kid-SecretKey List 외부로 절대 유출되어서는 안됩니다.
     */
    ...
    /**
     * 파라미터로 받은 kid로 SECRET_KEY_SET에서 Secret key 찾기
     *
     * @param kid kid
     * @return Key
     */
    public static Key getKey(String kid) {
        ...
        if (key == null)
            return null;
        return Keys.hmacShaKeyFor(key.getBytes(StandardCharsets.UTF_8));    // Secret Key의 길이에 따라 알아서 적절한 암호화
    }
}